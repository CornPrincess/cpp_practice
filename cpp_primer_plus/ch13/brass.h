...
#ifndef CPP_PRACTICE_BRASS_H
#define CPP_PRACTICE_BRASS_H
...
private:
    ...
    double balance;
public:
    Brass(const std::string &s = "Nullbody", long an = -1, double bal = 0.1);
